...
function Subscribe() {
  return (
    ...
    <div className="bg-[#DFD7F9] h-[407px] w-[90%] sm:w-[90vw] sm:h-[300px]  my-10 rounded-tl-[129px] rounded-xl relative ml-20 lg:ml-10 md:ml-10">
      ...
      <Spin delay={100} count={3}>
      <div
        className="h-[60px] w-[60px] bg-[#FF8C6C] flex items-center justify-center rounded-full absolute top-0 right-0 -mt-4 -mr-4
      "
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="text-white h-[45px] w-[40px] mb-2 rotate-45 ml-1.5"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
      ...
      <div className="flex justify-center items-center mt-36 xl:mt-20 lg:mt-10 md:mt-14">
        <div className="flex bg-white relative z-50 w-[421px] h-[68px] items-center rounded-md lg:w-[380px] lg:h-[58px] md:w-[380px] md:h-[52px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 ml-6 mr-2 text-slate-500 "
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth="1"
    ...
    <img src="/assets/decoreB.png" alt="" className="absolute -bottom-20 right-20 xl:-bottom-24 xl:right-8 xl:w-[150px] lg:-bottom-38 lg:right-1 md:-bottom-[50px] md:w-[100px] md:right-1" />
    </div>
  );
}
