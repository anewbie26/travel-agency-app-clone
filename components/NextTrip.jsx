      ...
      <Tada>
        <div className=" shadow-lg mr-56 sm:mr-20 rounded-2xl h-[400px] w-[370px] sm:h-[300px] sm:w-[330px] group bg-white m-auto hover:scale-105 transition-all duration-200 xl:mr-28">
          <img
            ...
            alt=""
          />
          <h1 className="font-bold ml-8 mt-6 sm:mt-3 sm:ml-4 sm:text-sm lg:mt-1">Trip To Boracay</h1>
              ...
              <div className=" absolute bottom-8 left-52 bg-white h-[130px] w-[263px] flex rounded-2xl shadow-xl sm:h-[100px] sm:w-[220px] sm:left-48">
                <div>
                  <img
                    src="/assets/sea.png"
                    alt=""
                    className="h-14 w-14 rounded-full ml-4 mt-4 sm:h-10 sm:w-10 lg:h-12 lg:w-12"
                  />
                </div>
                <div className="flex flex-col mx-4 mt-4 lg:mx-2">
                  <p className="sm:text-xs">Ongoing</p>
                  <h1 className="mb-3 font-bold sm:text-sm sm:mb-1 lg:mb-2">Trip to Baguio</h1>
